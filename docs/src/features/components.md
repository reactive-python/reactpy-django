...
??? question "How do I use `strict_parsing`, `compatibility`, and `transforms`?"
    ...
    After your view has been turned into [VDOM](https://reactpy.herokuapp.com/docs/reference/specifications.html#vdom) (python dictionaries), `view_to_component` will call your `transforms` functions on every VDOM node.
